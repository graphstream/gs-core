 ...
 * 
 * <p>
 * In this format, edges have no identifier. By default an automatic identifier is added to each
 * edge. You can add an identifier to an edge by adding an "id" attribute to the edge. For example :
 * <pre>
 *    A -- B [ id=AB ];
 * </pre>
 * </p>
 */
public class FileInputDOT extends FileInputBase
{
// Attribute
...
// Commands
	 ...
	 * else do nothing.
	 */
	protected void maybeParseAttributeBlock( String element, HashMap<String,Object> attributes ) throws IOException
	{
		char s;
...
//			node1_id = SG.get_id();
	...
	protected void putAttribute( String id, Object value, HashMap<String,Object> attributes )
	{
