 ...
 * 
 * <p>
 * This is a piece of crap, but used in so many places... :-(
 * TODO use a parser generator (jj ?)
 * </p>
 * 
 * <p>
 ...
 * </p>
 */
abstract class FileInputBase extends InputBase implements FileInput
{
// Attributes
...
// Constructors
	 ...
	 *        it is ignored.
	 */
	FileInputBase( boolean eol_is_significant )
	{
	 ...
	 */
	FileInputBase( boolean eol_is_significant, int commentChar,
			int quoteChar )
	{
		this.eol_is_significant = eol_is_significant;
...
// Command -- Parsing -- Include mechanism
	...
	{
		throw new IOException( "parse error: " + filename + ": "
				+ st.lineno() + ": " + message );
	}
