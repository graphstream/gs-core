 ...
 * 
 * <p>
 * This format only contains edges. To ensure the "add node" events are sent before an edge
 * referencing two nodes is created via an "add edge" event, this reader has a hash set
 * of already encountered nodes. The hash set allows to issue "add node" events only when
 * a node is encountered for the first time.
 * </p>
 * 
 * </p>
 ...
 * </p>
 */
public class FileInputEdge extends FileInputBase
{
// Attribute
...
// Construction
	 ...
	 */
	public FileInputEdge( boolean edgesAreDirected )
	{
	 ...
	 */
	public FileInputEdge( boolean edgesAreDirected, boolean declareNodes )
	{
