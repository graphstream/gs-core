...
public class FileInputFactory
{
	 ...
	 */
	public static FileInput inputFor( String fileName ) throws IOException
	{
...
//					return new FileInputDGS1And2();
		...
		if( flc.endsWith( ".dot" ) ) 
		{
			return new FileInputDOT();
		}
		
		if( flc.endsWith( ".edge" ) )
		{
			return new FileInputEdge();
		}
