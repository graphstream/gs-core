...
public interface FileOutput extends Output
{
	 ...
	 * any descendant of {@link Input} will do).
	 ...
	 * input (implementation of {@link Input} or you can directly use the methods inherited from
	 * {@link GraphListener}. Once the writing is started using begin(), you must close
