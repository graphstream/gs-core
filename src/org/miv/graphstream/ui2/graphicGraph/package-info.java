 ...
 * named {@link org.miv.graphstream.ui2.graphicGraph.GraphicGraph} that also defines
 ...
 * 
 * <p>
 * The graphic graph uses a set of {@link org.miv.graphstream.ui2.graphicGraph.StyleGroup}s
 ...
 * {@link org.miv.graphstream.ui2.graphicGraph.StyleGroupSet} that listens at the style
 * sheet and at the graph and creates the style groups for elements, call the graphic
 * graph each time the style changes, etc.
 * </p>
 * 
 * <p>
 * The graphic graph is constructed like any other instance of {@link org.miv.graphstream.graph.Graph}
 ...
 * nodes and edges : {@link org.miv.graphstream.ui2.graphicGraph.GraphicNode} and
 * {@link org.miv.graphstream.ui2.graphicGraph.GraphicEdge}. In addition the notion
 * of sprite is added with the {@link org.miv.graphstream.ui2.graphicGraph.GraphicSprite}. The
 * sprites are not really graph elements, but are treated the same in the graphic
 * graph. They can have attributes as well.
 * </p>
 * 
 * <p>
 * All this graph elements inherit the {@link org.miv.graphstream.ui2.graphicGraph.GraphicElement}
 * class that in turn implements {@link org.miv.graphstream.graph.Element}. The graphic element
 ...
 * 
 * <p>
 * This package and the main class {@link org.miv.graphstream.ui2.graphicGraph.GraphicGraph}
