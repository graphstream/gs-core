...
import org.graphstream.oldUi.GraphViewer.ScreenshotType;
...
// The "sprite" API.
	 ...
	 * 
	 * <p>
	 * The use of this method is discouraged, use the corresponding {@link Sprite#position(float, float, float, org.graphstream.oldUi.graphicGraph.stylesheet.Style.Units)}
	 * method of the {@link Sprite} class.
	 * </p>
	 * 
	 * @param id The sprite identifier.
	...
	/**
	 * Like {@link #positionSprite(String, float, float, float, org.graphstream.oldUi.graphicGraph.stylesheet.Style.Units)}
