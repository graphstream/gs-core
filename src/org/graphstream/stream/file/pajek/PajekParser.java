/* Generated By:JavaCC: Do not edit this line. PajekParser.java */
...
/** Unused rule, call it to slurp in the whole file. */
  ...
  final public boolean nextEvents() throws ParseException {
        boolean ok = true;
        Token k;
    if (jj_2_2(2)) {
      network();
    ...
    while (true) {
      ...
      if (jj_2_9(2)) {
        k = jj_consume_token(STRING);
                               if(!first) buf.append(" "); buf.append(k.image.substring(1, k.image.length()-1)); first=false;
      } else if (jj_2_10(2)) {
        k = jj_consume_token(KEY);
                               if(!first) buf.append(" "); buf.append(k.image); first=false;
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
    }
          pajek.addGraphAttribute("ui.label", buf.toString());
    EO();
  }
  ...
  final public void vertex() throws ParseException {
      ...
      if (jj_2_47(2)) {
        ...
        if (jj_2_20(2)) {
          ...
          ;
                                                                                     ...
                                                                                     pajek.addNodePosition(id.image, x, y, z);
        if (jj_2_27(2)) {
          if (jj_2_21(2)) {
            k = jj_consume_token(ELLIPSE);
                                          if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("shape", "circle",   k);
          } else if (jj_2_22(2)) {
            k = jj_consume_token(BOX);
                                                  if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("shape", "box",      k);
          } else if (jj_2_23(2)) {
            k = jj_consume_token(TRIANGLE);
                                          if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("shape", "triangle", k);
          } else if (jj_2_24(2)) {
            k = jj_consume_token(CROSS);
                                          if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("shape", "cross",    k);
          } else if (jj_2_25(2)) {
            k = jj_consume_token(DIAMOND);
                                          if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("shape", "diamond",  k);
          } else if (jj_2_26(2)) {
        ...
        while (true) {
          ...
          if (jj_2_29(2)) {
            ...
            value = number();
                                                            if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("s_size", value, k);
          } else if (jj_2_30(2)) {
            ...
            value = color();
                                                            if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("ic", value, k);
          } else if (jj_2_36(2)) {
            k = jj_consume_token(BC);
            value = color();
                                                            if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("bc", value, k);
          } else if (jj_2_37(2)) {
            k = jj_consume_token(BW);
            value = number();
                                                            if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("bw", value, k);
          } else if (jj_2_38(2)) {
            k = jj_consume_token(LC);
            value = color();
                                                            if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("lc", value, k);
          } else if (jj_2_39(2)) {
            ...
            value = number();
                                                            if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("fos",  value, k);
          } else if (jj_2_43(2)) {
            k = jj_consume_token(FONT);
            value = keyOrString();
                                                            if(graphics==null) graphics = new NodeGraphics(); graphics.addKey("font", value, k);
          } else {
            jj_consume_token(-1);
            throw new ParseException();
          }
    ...
    EO();
                if(label != null) {
                        ...
                        pajek.addNodeLabel(id.image, label);
                }
                if(graphics != null )
                        pajek.addNodeGraphics(id.image, graphics);
  }
...
// Edges and edge lists.
  final public void edges() throws ParseException {
    if (jj_2_61(2)) {
      ...
      EO();
                               edgeListMode = false; inVertices = false; pajek.setDirected(true);
      label_6:
      while (true) {
        if (jj_2_49(2)) {
          ;
      ...
      EO();
                               edgeListMode = false; inVertices = false; pajek.setDirected(false);
      label_7:
      while (true) {
        if (jj_2_52(2)) {
          ;
      ...
      EO();
                               edgeListMode = true;  inVertices = false; pajek.setDirected(true);
      label_8:
      while (true) {
        if (jj_2_55(2)) {
          ;
      ...
      EO();
                               edgeListMode = true;  inVertices = false; pajek.setDirected(false);
      label_9:
      while (true) {
        if (jj_2_58(2)) {
          ;
  ...
  final public void edge() throws ParseException {
    ...
    trg = jj_consume_token(INT);
                              id=pajek.addEdge(src.image, trg.image);
    if (jj_2_95(2)) {
      if (jj_2_67(2)) {
      ...
      while (true) {
        ...
        if (jj_2_72(2)) {
          ...
          value = keyOrString();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("p",    value, k);
        } else if (jj_2_73(2)) {
          k = jj_consume_token(W);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("w",    value, k);
        } else if (jj_2_74(2)) {
          k = jj_consume_token(C);
          value = color();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("c",    value, k);
        } else if (jj_2_75(2)) {
          k = jj_consume_token(S);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("s",    value, k);
        } else if (jj_2_76(2)) {
          ...
          if (jj_2_70(2)) {
            ...
            throw new ParseException();
                                                    ...
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("a",    k.image, k);
        } else if (jj_2_77(2)) {
          k = jj_consume_token(AP);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("ap",   value, k);
        } else if (jj_2_78(2)) {
          k = jj_consume_token(L);
          value = keyOrString();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("l",    value, k);
        } else if (jj_2_79(2)) {
          k = jj_consume_token(LP);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("lp",   value, k);
        } else if (jj_2_80(2)) {
          k = jj_consume_token(LR);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("lr",   value, k);
        } else if (jj_2_81(2)) {
          k = jj_consume_token(LPHI);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("lphi", value, k);
        } else if (jj_2_82(2)) {
          k = jj_consume_token(LC);
          value = color();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("lc",   value, k);
        } else if (jj_2_83(2)) {
          k = jj_consume_token(LA);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("la",   value, k);
        } else if (jj_2_84(2)) {
          k = jj_consume_token(FOS);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("fos",  value, k);
        } else if (jj_2_85(2)) {
          k = jj_consume_token(FONT);
          value = keyOrString();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("font", value, k);
        } else if (jj_2_86(2)) {
          k = jj_consume_token(H1);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("h1",   value, k);
        } else if (jj_2_87(2)) {
          k = jj_consume_token(H2);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("h2",   value, k);
        } else if (jj_2_88(2)) {
          k = jj_consume_token(A1);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("a1",   value, k);
        } else if (jj_2_89(2)) {
          k = jj_consume_token(A2);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("a2",   value, k);
        } else if (jj_2_90(2)) {
          k = jj_consume_token(K1);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("k1",   value, k);
        } else if (jj_2_91(2)) {
          k = jj_consume_token(K2);
          value = number();
                                                    if(graphics==null) graphics = new EdgeGraphics(); graphics.addKey("k2",   value, k);
        } else {
          jj_consume_token(-1);
          throw new ParseException();
        }
    ...
    EO();
                if(graphics != null)
                        pajek.addEdgeGraphics(id, graphics);
  }
  ...
  final public void edgeList() throws ParseException {
    ...
    while (true) {
      ...
      more = jj_consume_token(INT);
                       if(edgeListMode) pajek.addEdge(src.image, more.image);
    }
    EO();
  }
  ...
  final public String color() throws ParseException {
    ...
    if (jj_2_106(2)) {
      ...
      b = jj_consume_token(REAL);
                                          value = pajek.toColorValue(r, g, b);
    } else if (jj_2_108(2)) {
