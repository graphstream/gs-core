...
// Attributes
	...
	/**
	 * Control points for curved edges or polylines. This contains the control points of an edge.
...
// Constructors
	...
	/**
	 * True if the the edge defines control points to draw a curve or polyline. This does not mean
	...
	/**
	 * Count the number of identical edges between the two nodes of this edge and create or update
	 * the edge group. The edge group contains all the edges between two same nodes and allows to
	 * render faster multiple edges in a multigraph.
	 * @param edgeList The actual set of edges between two nodes (see the connectivity in the
	 * graphic graph).
	 */
