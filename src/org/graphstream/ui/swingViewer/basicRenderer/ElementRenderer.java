...
// Command
	...
	public void render( StyleGroup group, Graphics2D g, Camera camera )
	{
		...
		for( Element e: group.bulkElements() )
		{
			...
			else elementInvisible( group, g, camera, ge );
		}
	 ...
	 * @param camera The camera.
	 */
	protected abstract void pushStyle( StyleGroup group, Graphics2D g, Camera camera );
	 ...
	 */
	protected abstract void pushDynStyle( StyleGroup group, Graphics2D g, Camera camera, GraphicElement element );
	 ...
	 */
	protected abstract void renderElement( StyleGroup group, Graphics2D g, Camera camera, GraphicElement element );
	
	/**
	 * Called during rendering in place of {@link #renderElement(StyleGroup, Graphics2D, Camera, GraphicElement)}
