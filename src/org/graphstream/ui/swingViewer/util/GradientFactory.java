...
public class GradientFactory
{
		...
		if( style.getFillColorCount() > 1 )
		{
			switch( style.getFillMode() )
			{
				...
				case GRADIENT_VERTICAL:
					...
					else paint = new GradientPaint( x0, y0, style.getFillColor( 0 ), x1, y1, style.getFillColor( 1 ) );
					break;
				default:
					break;
			}
	...
	/**
	 * Generate a radial gradient between whose center is at (cx,cy) with the given radius. The
