...
public class Connector extends HasSkel {
	...
	public void configureConnectorForGroup(Style style, ScalaDefaultCamera camera) {
		sizeForGroup(style, camera);
	}

	public void configureConnectorForElement(ScalaDefaultCamera camera, GraphicEdge element, ConnectorSkeleton skel) {
		this.skel = skel;
	...
	private void sizeForElement(StyleGroup style, ScalaDefaultCamera camera, GraphicEdge element) {
	...
	public void endPoints(GraphicNode from, GraphicNode to, boolean directed, ScalaDefaultCamera camera) {
	...
	public void endPoints(StyleGroup sourceStyle, StyleGroup targetStyle, boolean directed, ScalaDefaultCamera camera) {
