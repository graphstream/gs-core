...
public abstract class IconAndText {
	...
	public static IconAndText apply(Style style, ScalaDefaultCamera camera, GraphicElement element) {
	...
	public abstract void render(Backend backend, ScalaDefaultCamera camera, double xLeft, double yBottom) ;
...
class IconAndTextOnlyText extends IconAndText {
	...
	public void render(Backend backend, ScalaDefaultCamera camera, double xLeft, double yBottom) {
...
abstract class TextBox {
	...
	public static TextBox apply(ScalaDefaultCamera camera, Style style) {
