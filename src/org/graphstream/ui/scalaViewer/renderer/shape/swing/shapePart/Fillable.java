...
import org.graphstream.ui.scalaViewer.renderer.shape.swing.ShapePaint;
import org.graphstream.ui.scalaViewer.renderer.shape.swing.ShapePaint.ShapeAreaPaint;
import org.graphstream.ui.scalaViewer.renderer.shape.swing.ShapePaint.ShapeColorPaint;
import org.graphstream.ui.scalaViewer.renderer.shape.swing.ShapePaint.ShapePlainColorPaint;
...
public class Fillable {
	...
	public void fill(Graphics2D g, double dynColor, Color optColor, java.awt.Shape shape, ScalaDefaultCamera camera) {
		if(plainFast) {
	 ...
	 * @param g The Java2D graphics.
	 * @param shape The awt shape to fill. */
 	public void fill(Graphics2D g, java.awt.Shape shape, ScalaDefaultCamera camera) { fill( g, theFillPercent, theFillColor, shape, camera ); }

    /** Configure all static parts needed to fill the shape. */
 	public void configureFillableForGroup(Backend bck, Style style, ScalaDefaultCamera camera ) {
    ...
    /** Configure the dynamic parts needed to fill the shape. */
  	public void configureFillableForElement( Style style, ScalaDefaultCamera camera, GraphicElement element ) {
