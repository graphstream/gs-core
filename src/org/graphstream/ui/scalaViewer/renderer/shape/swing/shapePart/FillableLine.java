...
public class FillableLine {
	...
	public void configureFillableLineForGroup(Backend bck, Style style, ScalaDefaultCamera camera, double theSize) {
	...
	public void configureFillableLineForElement( Style style, ScalaDefaultCamera camera, GraphicElement element ) {
		theFillPercent = 0 ;
