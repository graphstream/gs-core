...
import org.graphstream.ui.scalaViewer.renderer.shape.swing.baseShapes.AreaConnectorShape;
...
public class AngleShape extends AreaConnectorShape {
	...
	private void makeOnCurve(ScalaDefaultCamera camera, double sox, double soy, double swx, double swy) {
		if (skel.isLoop())
	...
	private void makeOnPolyline(ScalaDefaultCamera camera, double sox, double soy, double swx, double swy) {
		makeOnLine(camera, sox, soy, swx, swy);
	}

	private void makeOnLine(ScalaDefaultCamera camera, double sox, double soy, double swx, double swy) {
