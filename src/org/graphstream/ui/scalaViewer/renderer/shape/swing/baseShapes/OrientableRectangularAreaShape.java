...
import org.graphstream.ui.scalaViewer.renderer.shape.Orientable;
...
public class OrientableRectangularAreaShape extends RectangularAreaShape {
	...
	public void make(Backend backend, ScalaDefaultCamera camera) {make(backend, false, camera);}
	
 	public void makeShadow(Backend backend, ScalaDefaultCamera camera) {make(backend, true, camera);}

	private void make(Backend bck, boolean forShadow, ScalaDefaultCamera camera) {
		if (oriented) {
