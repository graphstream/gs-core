...
public abstract class ShapeDecor {
	 ...
	 *  `style` and `camera`. */
	public IconAndText iconAndText(Style style, ScalaDefaultCamera camera, GraphicElement element ) {
	...
	/** Render the decoration inside the given box coordinates. The shape decoration contains all the metrics
	  ...
	  * drawn. */
	public abstract void renderInside(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText, double x0, double y0, double x1, double y1 );
	...
	public abstract void renderAlong(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText, double x0, double y0, double x1, double y1 );
	public abstract void renderAlong(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText, ConnectorSkeleton skel);
	...
	public abstract Tuple<Double, Double> size(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText);
}

/** A decor that does nothing. */
class EmptyShapeDecor extends ShapeDecor {
	public void renderInside(Backend b, ScalaDefaultCamera camera, IconAndText iconAndText, double x0, double y0, double x1, double y1) {}
	public void renderAlong(Backend b, ScalaDefaultCamera camera, IconAndText iconAndText, double x0, double y0, double x1, double y1) {}
	public void renderAlong(Backend b, ScalaDefaultCamera camera, IconAndText iconAndText, ConnectorSkeleton skel) {}
	public Tuple<Double, Double> size(Backend b, ScalaDefaultCamera camera, IconAndText iconAndText) {
...
abstract class PxShapeDecor extends ShapeDecor {
	 ...
	 * this case ? 
	 */
	protected void renderGu2Px(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText, double x, double y, double angle,
...
class CenteredShapeDecor extends PxShapeDecor {
	...
	@Override
	public void renderInside(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText, double x0, double y0,
			double x1, double y1) {
	...
	@Override
	public void renderAlong(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText, double x0, double y0,
			double x1, double y1) {
	...
	@Override
	public void renderAlong(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText, ConnectorSkeleton skel) {
...
class AtLeftShapeDecor extends PxShapeDecor {
	...
	@Override
	public void renderAlong(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText,
			ConnectorSkeleton skel) {
		renderAlong(backend, camera, iconAndText, skel.from().x, skel.from().y, skel.to().x, skel.to().y);		
	}

	@Override
	public Tuple<Double, Double> size(Backend backend, ScalaDefaultCamera camera, IconAndText iconAndText) {
		return new Tuple<Double, Double>(0.0, 0.0);
	}
