...
public interface Shape {
	...
	void configureForGroup(Backend backend, Style style, ScalaDefaultCamera camera) ;
	...
	/** Configure all the dynamic and per element settings.
	  ...
	  * @param camera the view parameters. */
	void configureForElement(Backend backend, GraphicElement element, Skeleton skeleton, ScalaDefaultCamera camera);
     ...
     * @param backend The rendering back-end.
     * @param camera the view parameters. */
	void make(Backend backend, ScalaDefaultCamera camera);
	...
	/** Same as {@link #make(Camera)} for the shadow shape. The shadow shape may be moved and
 	...
 	void makeShadow(Backend backend, ScalaDefaultCamera camera);
     ...
     * @param skeleton The element geometry and information. */
 	void render(Backend bck, ScalaDefaultCamera camera, GraphicElement element, Skeleton skeleton);
     ...
     * than usual rendering, therefore it is a separate method. */
 	void renderShadow(Backend bck, ScalaDefaultCamera camera, GraphicElement element, Skeleton skeleton);
}
