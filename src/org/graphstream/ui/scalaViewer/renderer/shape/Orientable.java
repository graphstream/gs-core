...
public class Orientable {
	...
	public void configureOrientableForGroup(Style style, ScalaDefaultCamera camera) { orientation = style.getSpriteOrientation(); }
	
	/** Compute the orientation vector for the given element according to the orientation mode. */
	public void configureOrientableForElement(ScalaDefaultCamera camera, GraphicSprite sprite) {
	...
	private void setTargetOnLineEdge(ScalaDefaultCamera camera, GraphicSprite sprite, GraphicEdge ge) {
