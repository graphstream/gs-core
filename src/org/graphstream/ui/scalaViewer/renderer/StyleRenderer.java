...
public abstract class StyleRenderer implements GraphicElement.SwingElementRenderer {
	...
	public static StyleRenderer apply(StyleGroup style, ScalaGraphRenderer mainRenderer) {
...
// Command
	...
	public void renderShadow(Backend bck, ScalaDefaultCamera camera) { render(bck, camera, true, renderShadow); }
 
	/** Render all the (visible) elements of the group. */
	public void render(Backend bck, ScalaDefaultCamera camera) { render(bck, camera, false, renderElement); }
	...
	public void render(Backend bck, ScalaDefaultCamera camera, boolean shadow, FunctionInVoid<Backend, ScalaDefaultCamera, GraphicElement> render) {
...
//var T2 = System.currentTimeMillis
	...
	public abstract void setupRenderingPass(Backend bck, ScalaDefaultCamera camera, boolean forShadow);
	
	/** Called before the rendering of bulk and event elements.
	 * @param bck The rendering back-end.
	 * @param camera The camera.
	 * @param forShadow true if we are in the shadow rendering pass. */
	public abstract void pushStyle(Backend bck, ScalaDefaultCamera camera, boolean forShadow);
	...
	public abstract void pushDynStyle(Backend bck, ScalaDefaultCamera camera, GraphicElement element);
	...
	public abstract void renderElement(Backend bck, ScalaDefaultCamera camera, GraphicElement element);
	
	FunctionInVoid<Backend, ScalaDefaultCamera, GraphicElement> renderElement = (Backend bck, ScalaDefaultCamera camera, GraphicElement element) -> {
	 ...
	 * @param camera The camera.
	 * @param element The element to render. */
	public abstract void renderShadow(Backend bck, ScalaDefaultCamera camera, GraphicElement element);
	
	FunctionInVoid<Backend, ScalaDefaultCamera, GraphicElement> renderShadow = (Backend bck, ScalaDefaultCamera camera, GraphicElement element) -> {
		renderShadow(bck, camera, element);
	};
	
	/** Called during rendering in place of {@link #renderElement(Graphics2D, ScalaDefaultCamera, GraphicElement)}
	 ...
	 * @param camera The camera.
	 * @param element The element to render. */
	public abstract void elementInvisible(Backend bck, ScalaDefaultCamera camera, GraphicElement element);
	
	/** Called at the end of the rendering pass. 
	 * @param bck The rendering back-end.
	 * @param camera The camera.
	 * @param forShadow true if we are in the shadow rendering pass. */
	public abstract void endRenderingPass(Backend bck, ScalaDefaultCamera camera, boolean forShadow) ;
}
