...
public class ShapeUtil {
	...
	/** Try to evaluate the "radius" of the edge target node shape along the edge. In other words
	  ...
	  * @return The radius. */
	public static double evalTargetRadius2D(GraphicEdge edge, ScalaDefaultCamera camera) {
	...
	/** Try to evaluate the "radius" of the given node considering an edge between points `from` and `to`.
	  ...
	  * @param the camera.
	  * @return The radius. */
	public static double evalTargetRadius2D(Point3 from, Point3 to, GraphicNode node, ScalaDefaultCamera camera) {
	...
	/** Try to evaluate the "radius" of the given area skeleton considering an edge between points `p0` and
	  ...
	  * @param camera the camera.
	  * @return the radius. */
  	public static double evalTargetRadius2D(Style style, AreaSkeleton skeleton, Point3 p0, Point3 p3, ScalaDefaultCamera camera) {
	  ...
	  * @param camera the camera.
	  * @return the radius. */
 	public static double evalTargetRadius2D(GraphicEdge edge, Point3 p0, Point3 p1, Point3 p2, Point3 p3, ScalaDefaultCamera camera) {
	  ...
	  * @param camera the camera.
	  * @return the radius. */
 	public static double evalTargetRadius2D(Style style, AreaSkeleton skeleton, Point3 p0, Point3 p1, Point3 p2, Point3 p3, ScalaDefaultCamera camera) { 
 	  	double w = 0.0;
 	  	double h = 0.0;
 	  	double s = 0f ;
