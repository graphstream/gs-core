...
// Commands
	 ...
	 */
	public void
	unionOf( Box2 a, Box2 b ) throws IllegalArgumentException
	{
		if( a == this || b == this )
		{
	 ...
	 */
	public void
	unionWith( Box2 other ) throws IllegalArgumentException
	{
		if( other == this )
		{
	 ...
	 */
	public void
	intersectionOf( Box2 a, Box2 b ) throws IllegalArgumentException
	{
		if( a == this || b == this )
		{
			throw new IllegalArgumentException( "parameter cannot be this" );
	 ...
	 */
	public void
	intersectionWith( Box2 other ) throws IllegalArgumentException
	{
		if( other == this )
		{
