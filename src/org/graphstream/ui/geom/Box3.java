...
// Commands
	 ...
	 */
	public void
	unionOf( Box3 a, Box3 b ) throws IllegalArgumentException
	{
		if( a == this || b == this )
		{
	 ...
	 */
	public void
	unionWith( Box3 other ) throws IllegalArgumentException
	{
		if( other == this )
		{
	 ...
	 */
	public void
	intersectionOf( Box3 a, Box3 b ) throws IllegalArgumentException
	{
		if( a == this || b == this )
		{
			throw new IllegalArgumentException( "parameter cannot be this" );
	 ...
	 */
	public void
	intersectionWith( Box3 other ) throws IllegalArgumentException
	{
		if( other == this )
		{
